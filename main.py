...
html_code = """
<div style="text-align:center; font-size: 24px; color: #4CAF50; margin-top: 20px;">
  <h3>Use your hands to control volume and brightness</h3>
</div>
<div style="text-align:center;">
  <button id="start-btn" style="padding:10px 20px; background-color:#4CAF50; color:white; border:none; border-radius: 5px; cursor: pointer;">Start Camera</button>
</div>
<script>
  document.getElementById("start-btn").onclick = function() {
    alert("Camera started! Please show your hands for gestures.");
  }
</script>
"""
